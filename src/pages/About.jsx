...
import {
  Home, MapPin, HeadphonesIcon,
  ArrowRight, Star, Shield, Award, PhoneCall,
  CalendarDays, ChevronRight, TrendingUp, Users,
  ...
  return (
    <div className="overflow-x-hidden text-[#1E2D1A]" style={{ background: "#F0F5ED" }}>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center w-full max-w-[680px] mx-auto py-24 sm:py-28">
          <FadeUp delay={0.05}>
            <Eyebrow light>Est. 2010 · Trusted Real Estate</Eyebrow>
          </FadeUp>

          {/* ✅ FIX: was hardcoded "80px" — now clamp */}
          <FadeUp delay={0.18}>
            <h1
              style={{
                ...FF_HEAD,
          ...
          <FadeUp delay={0.55}>
            {/* ✅ FIX: gap-x-4 gap-y-3 so badges wrap cleanly on mobile */}
            <div className="flex justify-center items-center gap-x-4 gap-y-3 flex-wrap mt-8">
              {[
                ...
                >
                  <span className="w-1 h-1 rounded-full inline-block flex-shrink-0" style={{ background: G.green }} />
      ...
      <section className="max-w-[1200px] mx-auto px-4 sm:px-8 lg:px-10 py-14 sm:py-20 lg:py-28">
        <FadeUp className="text-center mb-10 sm:mb-14">
          ...
          <p style={FF_BODY} className="text-[0.86rem] text-[#7A9B72] mt-3 max-w-[440px] mx-auto leading-[1.74]">
            ...
            <FadeUp key={i} delay={i * 0.08}>
              ...
              >
                <div className="flex items-center justify-between mb-4 sm:mb-5">
                  ...
                  <span
                    style={{ ...FF_BODY, color: G.green, background: G.greenLight, border: `1px solid ${G.greenBorder}` }}
                ...
                <h3
                  style={{ ...FF_HEAD, textTransform: "uppercase", letterSpacing: ".08em", fontSize: "clamp(0.88rem,2vw,1.05rem)" }}
                  className="text-[#1E2D1A] mb-2"
                >
                  {c.title}
                </h3>
                <p style={FF_BODY} className="text-[0.82rem] sm:text-[0.84rem] leading-[1.75] text-[#7A9B72] flex-1">
                  {c.desc}
                </p>
              </motion.div>
            </FadeUp>
      ...
      <section style={{ background: "#fff" }}>
        <div className="max-w-[1200px] mx-auto px-4 sm:px-8 lg:px-10 py-14 sm:py-20 lg:py-28 grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-center">
          ...
          <FadeUp delay={0} className="relative w-full">
            {/* ✅ decorative frame hidden on mobile — prevents overflow */}
            <div
            ...
            {/* ✅ small circle — responsive sizes, won't overflow */}
            <div
              className="absolute -bottom-5 right-2 sm:-right-4 w-[76px] sm:w-[108px] lg:w-[128px] h-[76px] sm:h-[108px] lg:h-[128px] rounded-full overflow-hidden border-4 border-white z-20"
            ...
            {/* ✅ float badge — stays inside on mobile */}
            <motion.div
              className="absolute top-4 sm:top-7 right-2 sm:-right-4 lg:-right-5 bg-white rounded-[18px] p-3 sm:p-4 flex items-center gap-2 sm:gap-3 z-30"
            ...
            >
              ...
              <div>
                <p style={{ ...FF_HEAD, fontSize: "clamp(1.1rem,3vw,1.55rem)", color: G.green, lineHeight: 1 }}>1000+</p>
          ...
          <FadeUp delay={0.2} className="flex flex-col items-start">
            ...
            <Divider />
            <h2
              style={{ ...FF_HEAD, fontSize: "clamp(1.8rem,4vw,3.4rem)", textTransform: "uppercase", letterSpacing: ".05em", lineHeight: 1.05 }}
            ...
            >
              {[
                { num: "14+", lbl: "Years" }, null,
                { num: "1000+", lbl: "Clients" }, null,
                ...
                s === null ? (
                  ...
                  <div key={i} className="flex flex-col gap-1 flex-1 min-w-0">
                    <span style={{ ...FF_HEAD, fontSize: "clamp(1rem, 3vw, 1.45rem)", color: G.green, lineHeight: 1 }}>
                      {s.num}
                    </span>
                    <span style={FF_BODY} className="text-[0.55rem] sm:text-[0.58rem] font-semibold tracking-[0.1em] uppercase text-[#7A9B72] truncate">
                      {s.lbl}
                    </span>
                  </div>
                )
      ...
      <section style={{ background: G.greenDeep }} className="py-14 sm:py-20 lg:py-28">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-8 lg:px-10 text-center">
          <FadeUp>
            ...
            <Divider center />
            <h2
              style={{ ...FF_HEAD, fontSize: "clamp(1.4rem,4vw,3.2rem)", textTransform: "uppercase", letterSpacing: ".06em", lineHeight: 1.1 }}
            ...
            {[
              ...
              <FadeUp key={i} delay={i * 0.15}>
                ...
                >
                  ...
                  <h3
                    style={{ ...FF_HEAD, fontSize: "clamp(1rem,2.5vw,1.15rem)", textTransform: "uppercase", letterSpacing: ".08em" }}
                    className="text-white mb-3"
                  >
                    {c.title}
                  </h3>
                  <p style={FF_BODY} className="text-[0.82rem] sm:text-[0.84rem] leading-[1.75] text-[rgba(255,255,255,0.58)] flex-1">
                    {c.desc}
                  </p>
                </motion.div>
              </FadeUp>
      ...
      <section className="max-w-[1200px] mx-auto px-4 sm:px-8 lg:px-10 py-14 sm:py-20 lg:py-28">
        <FadeUp className="mb-8 sm:mb-10">
          ...
          <Divider />
          <h2
            style={{ ...FF_HEAD, fontSize: "clamp(2rem,5vw,4.5rem)", textTransform: "uppercase", letterSpacing: ".04em", lineHeight: 1 }}
            className="text-[#1E2D1A]"
          >
            BUY · SELL · RENT<br />
          ...
          {serviceCards.map((item, index) => (
            ...
            >
              ...
              <div className="p-5 sm:p-6">
                <p style={FF_BODY} className="text-[#7A9B72] text-[0.84rem] leading-[1.75]">{item.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-14 lg:gap-24 items-center">
          ...
          <FadeUp className="flex flex-col items-start" delay={0.05}>
            ...
            <Divider />
            <h2
              style={{ ...FF_HEAD, fontSize: "clamp(1.8rem,4vw,3.2rem)", textTransform: "uppercase", letterSpacing: ".05em", lineHeight: 1.05 }}
              className="text-white"
            >
            ...
            <div className="flex flex-col gap-3 mt-7 sm:mt-8 w-full max-w-[440px]">
              ...
              <motion.button
                style={{ ...FF_BODY, background: "#0F2808", border: `1px solid ${G.greenBorder}` }}
                className="flex items-center gap-3 sm:gap-4 px-4 sm:px-5 py-3 sm:py-4 rounded-[14px] cursor-pointer text-left text-white shadow-[0_4px_20px_rgba(0,0,0,0.25)] w-full"
          ...
          >
            ...
            <div
              ...
              className="absolute top-4 sm:top-5 right-4 sm:right-5 rounded-full px-3 sm:px-4 py-[0.3rem] sm:py-[0.38rem] text-[0.58rem] sm:text-[0.62rem] font-semibold tracking-[0.12em] uppercase text-white"
            >
              Verified &amp; Trusted
            </div>

            <motion.div
              className="absolute bottom-4 sm:bottom-5 left-4 sm:left-5 rounded-[18px] p-3 sm:p-4 max-w-[190px] sm:max-w-[240px]"
            ...
            >
              ...
              <p
                style={{ ...FF_HEAD, fontStyle: "italic", fontSize: "clamp(0.72rem,2vw,.82rem)", color: "rgba(255,255,255,0.85)", lineHeight: 1.55, marginBottom: ".5rem" }}
              >
                "Aryan Properties found us our dream flat in Sector 78 within a week. Absolutely trusted."
              </p>
              <p style={{ ...FF_BODY, color: G.green }} className="text-[0.62rem] sm:text-[0.65rem] font-semibold tracking-[0.06em]">
                — Rahul S., Noida
              </p>
            </motion.div>
          </FadeUp>
      ...
      {/* ════ FOUNDER ════ */}
      <section style={{ background: "#F0F5ED" }} className="py-14 sm:py-20 lg:py-28 px-4 sm:px-8 lg:px-10">
        <div className="max-w-[1200px] mx-auto">
          <FadeUp className="text-center mb-12 sm:mb-16">
            <Eyebrow>The Visionary</Eyebrow>
            <Divider center />
            <h2
              style={{ ...FF_HEAD, fontSize: "clamp(1.8rem,4vw,3.2rem)", textTransform: "uppercase", letterSpacing: ".06em" }}
              className="text-[#1E2D1A]"
            >
              MEET THE FOUNDER
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-12 sm:gap-16 lg:gap-24 items-center">
            ...
            <FadeUp delay={0} className="relative max-w-[420px] mx-auto w-full lg:max-w-none lg:mx-0">
              ...
              {/* ✅ stats badge — stays inside on mobile, pokes out sm+ */}
              <motion.div
                className="absolute bottom-4 sm:bottom-7 right-2 sm:-right-4 lg:-right-5 z-20 bg-white rounded-[20px] p-3 sm:p-4 shadow-[0_8px_36px_rgba(93,143,68,0.2)]"
                style={{ border: `1px solid ${G.greenBorder}`, maxWidth: 160 }}
                initial={{ opacity: 0, x: 30 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                transition={{ delay: 0.5, duration: 0.7 }}
              >
                <div className="mb-3 pb-3" style={{ borderBottom: `1px solid ${G.greenBorder}` }}>
                  <p style={{ ...FF_HEAD, fontSize: "clamp(1.15rem,3vw,1.6rem)", color: G.green, lineHeight: 1 }}>14+</p>
            ...
            <FadeUp delay={0.2} className="flex flex-col items-start">
              ...
              <h3
                style={{ ...FF_HEAD, fontSize: "clamp(2rem,5vw,3.4rem)", textTransform: "uppercase", letterSpacing: ".05em", lineHeight: 1 }}
                className="text-[#1E2D1A]"
              >
                ARYAN<br />SHARMA
              </h3>
              <p style={{ ...FF_BODY, color: G.green }} className="text-[0.62rem] sm:text-[0.65rem] font-semibold tracking-[0.18em] uppercase mt-2 mb-5">
